                ...
                <div class="gradient-cards">
                    <div class="car-1">
                        <div class="container-card bg-green-box">
                            ...
                            <p class="card-title-1">Zero-cost Possibilities</p>
                            <p class="card-description-1">Hubble lets users borrow USDH for a one-time 0.5% fee. No variable rates. No interest charged, ever.</p>
                        </div>
                    </div>
                    ...
                    <div class="card-1">
                        <div class="container-card bg-white-box">
                            ...
                            <p class="card-title-1">Multi-Asset Collateral</p>
                            <p class="card-description-1">Deposit a variety of assets on Hubble, raise your collateral ratio, and unlock the liquidity in your wallet.</p>
                        </div>
                    </div>
                    ...
                    <div class="card-1">
                        <div class="container-card bg-yellow-box">
                            ...
                            <p class="card-title-1">Get Yield on Deposits</p>
                            <p class="card-description-1">While your collateral is deposited, delegate it to earn the highest yield available in the Solana ecosystem.</p>
                        </div>
                    </div>
                    ...
                    <div class="card-1">
                        <div class="container-card bg-blue-box">
                            ...
                            <p class="card-title-1">Get up to 11x Leverage</p>
                            <p class="card-description-1">Hubble’s capital-efficient 110% collateral ratio lets users leverage up to 11x on their deposits.</p>
                        </div>
                    </div>
                </div>
            </div>
