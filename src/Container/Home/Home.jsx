      ...
      <div className="home-page-main">
        ...
        <section className='home-section-3' >
          ...
          <div className='home-card-container' >
            <div className="card position-relative home-shop-cards" style={{ width: "300px" }}>
              <img src="https://cdn4.iconfinder.com/data/icons/pop-scenes/1000/mobile_device_e-commerce___shopping_cart_online_shop_item_purchase-256.png" className="card-img" alt="Background Imagess" />
            ...
            <div className="card position-relative home-shop-cards" style={{ width: "300px" }}>
              <img src="https://cdn4.iconfinder.com/data/icons/pop-scenes/1000/error_404_mobile_device___warning_danger_not_found_calculator_calculate_hand_gesture-256.png" className="card-img" alt="Background Imagess" />
              <div className="card-text-overlay">
                <p className='btn btn-light'>Discover</p>
              </div>
            </div>
            ...
            <div className="card position-relative home-shop-cards" style={{ width: "300px" }}>
              <img src="https://cdn4.iconfinder.com/data/icons/pop-scenes/1000/delivery___logistic_package_box_insurance_security_document_tracking_shipment-256.png" className="card-img" alt="Background Imagess" />
              <div className="card-text-overlay">
                <p className='btn btn-light'>Discover</p>
              </div>
            </div>
